                ...
                <div class="info">
                    ...
                    <div class="info_image">
                        <div class="book-hover-media" data-hover-video>
                            <img src="../images/books/moment.svg" alt="" class="info_image-firefly">
                            <video src="../videos/moment.MP4" class="book-hover-video" muted loop playsinline></video>
                        </div>
                    </div>
                    <section class="info_description">
                        <div class="info_description-text">
                            <h2 class="info_description-title">Лови момент</h2>
                            ...
                            <div class="info_description-about">
                                <p class="info_description-about-title">О книге</p>
                                    <p class="info_description-about-text" id="text">
                                        «Лови момент» — увлекательная раскраска-антистресс, созданная Наталией Фершуковой с любовью. Несмотря на то, что автора уже нет, её работы продолжают вдохновлять и дарить тепло. Раскраска способствует развитию ребёнка: улучшает мелкую моторику, координацию, усидчивость
                                        <span class="more-text">
                                            и внимание, помогает подготовиться к письму. Продуманные иллюстрации развивают воображение, пространственное мышление и художественный вкус. Это не просто раскраска, а полезное и вдохновляющее занятие, помогающее детям расти и справляться со стрессом.
                                        </span>
