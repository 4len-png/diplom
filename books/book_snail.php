                ...
                <div class="info">
                    ...
                    <div class="info_image">
                        <div class="book-hover-media" data-hover-video>
                            <img src="../images/books/snail.svg" alt="" class="info_image-firefly">
                            <video src="../videos/snail.MP4" class="book-hover-video" muted loop playsinline></video>
                        </div>
                    </div>
                    <section class="info_description">
                        <div class="info_description-text">
                            <h2 class="info_description-title">Улитка</h2>
                            ...
                            <div class="info_description-about">
                                <p class="info_description-about-title">О книге</p>
                                    <p class="info_description-about-text" id="text">
                                        История о маленькой улитке, которая в жаркий день ищет прохладу и сталкивается с трудностями на пути к цели. 
                                        Достигнув края бочки с водой, она понимает, что впереди ещё долгий и непростой путь. 
                                        Это притча о том, как искренние стремления могут превращаться в испытание. Книга учит детей и взрослых осознавать свои чувства, ценить путь к цели и внутреннее состояние.
                                        <span class="more-text">
                                            Иллюстрации Анастасии Вороновой помогают лучше понять сюжет, а раскраски в конце делают чтение ещё интереснее. 
                                            Подходит для чтения и обсуждения: помогает говорить о настойчивости, страхах и поиске внутренних сил.
                                        </span>
