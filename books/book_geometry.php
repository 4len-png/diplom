                ...
                <div class="info">
                    ...
                    <div class="info_image">
                        <div class="book-hover-media" data-hover-video>
                            <img src="../images/books/geometry.svg" alt="" class="info_image-firefly">
                            <video src="../videos/geometry.MP4" class="book-hover-video" muted loop playsinline></video>
                        </div>
                    </div>
                    <section class="info_description">
                        <div class="info_description-text">
                            <h2 class="info_description-title">Геометрия жизни</h2>
                            ...
                            <div class="info_description-about">
                                <p class="info_description-about-title">О книге</p>
                                    <p class="info_description-about-text" id="text">
                                        Иногда повседневные дела захватывают полностью, и появляется желание побыть наедине с собой. В такие моменты помогает «терапия формой», с которой знакомит раскраска-антистресс «Геометрия жизни». Это не просто раскраска, а философия Наталии Фершуковой: в основе — круг, треугольник и
                                        <span class="more-text">
                                            квадрат как символы гармонии. Здесь нет правил — только вы, тишина и творчество. Разные узоры помогают настроению: ритмичные — наводят порядок в мыслях, симметричные — дают ощущение поддержки, а свободное раскрашивание позволяет выразить эмоции. «Геометрия жизни» напоминает, как важно находить время для себя и сохранять внутреннее равновесие.
                                        </span>
